                ...
                switch (subType) {
                   /* case GROUP_MSG_SUB_TYPE.COMMON:
                    ...
                    case GROUP_MSG_SUB_TYPE.LOVEMSG:
                        ...
                        break;*/
                    case GROUP_MSG_SUB_TYPE.MSG_NONE:
                        msgInfo.MsgPriority = "MSG_NONE";
                        break;
                    case GROUP_MSG_SUB_TYPE.MSG_Text:
                        msgInfo.MsgPriority = "MSG_Text";
                        break;
                    case GROUP_MSG_SUB_TYPE.MSG_FANS_ENTERLIVE:
                        msgInfo.MsgPriority = "MSG_FANS_ENTERLIVE";
                        break;
                    case GROUP_MSG_SUB_TYPE.MSG_FANS_EXITLIVE:
                        msgInfo.MsgPriority = "MSG_FANS_EXITLIVE";
                        break;
                    case GROUP_MSG_SUB_TYPE.MSG_Like:
                        msgInfo.MsgPriority = "MSG_Like";
                        break;
                    case GROUP_MSG_SUB_TYPE.MSG_BARRAGE:
                        msgInfo.MsgPriority = "MSG_BARRAGE";
                        break;
                    case GROUP_MSG_SUB_TYPE.MSG_STAR_GIFT:
                        msgInfo.MsgPriority = "MSG_STAR_GIFT";
                        break;
                    case GROUP_MSG_SUB_TYPE.MSG_STAR_RED_PACKAGE:
                        msgInfo.MsgPriority = "MSG_STAR_RED_PACKAGE";
                        break;
                    case GROUP_MSG_SUB_TYPE.MSG_FANS_GIFT:
                        msgInfo.MsgPriority = "MSG_FANS_GIFT";
                        break;
                    case GROUP_MSG_SUB_TYPE.MSG_STAR_EXITLIVE:
                        msgInfo.MsgPriority = "MSG_STAR_EXITLIVE";
                        break;
